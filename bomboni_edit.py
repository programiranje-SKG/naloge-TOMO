...
# želimo prepirov, joka in izsiljevanja, bi radi poskrbeli, da bodo imeli vsi otroci enako bombonov.
# Ker bombonov seveda ne moremo jemati (prepir, jok, izsiljevanje in te reči), je naša naloga
# napisati program, ki v spremenljivki `s` dobi seznam s številom bombonov, ki jih imajo
# otroci, nato pa na zaslon izpiše, koliko bombonov bo potrebno še razdeliti, da jih bodo imeli vsi
# otroci toliko, kolikor jih ima ta, ki jih ima največ.
# 
# Primer (prva vrstica programa):
# 
#     s = [5, 8, 6, 4]
# 
# Program naj na koncu preprosto izpiše število dodatnih bombonov:
# 
#     9
# 
