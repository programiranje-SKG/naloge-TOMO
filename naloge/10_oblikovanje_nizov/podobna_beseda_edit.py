...
# 
# V prvi vrstici naj se nahaja spremenljivka `besede`:
# 
#     besede = ["ana", "berta", "cilka", "dani", "ema", "fanci", "greta", "hilda"]
# 
# Izhod funkcije naj bo najbolj pogosta beseda, vendar izpisano v lepem nizu (uporabi oblikovanje stringov):
# 
#     >>> podobna("merjasec")
#     "Besedi 'merjasec' je najbolj podobna beseda 'berta'."
#     >>> podobna("zmaj")
#     "Besedi 'zmaj' je najbolj podobna beseda 'ema'."
#     >>> podobna("krava")
#     "Besedi 'krava' je najbolj podobna beseda 'berta'."
# 
...
def podobna(beseda):
    ...
    return f"Besedi '{beseda}' je najbolj podobna beseda '{naj_beseda}'."

Check.part()
Check.equal('podobna("merjasec")', "Besedi 'merjasec' je najbolj podobna beseda 'berta'.")
Check.equal('podobna("zmaj")', "Besedi 'zmaj' je najbolj podobna beseda 'ema'.")
Check.equal('podobna("krava")', "Besedi 'krava' je najbolj podobna beseda 'berta'.")
