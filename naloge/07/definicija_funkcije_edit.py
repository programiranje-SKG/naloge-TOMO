...
Check.part()
Check.equal("zepnina(800, 0.03)", 24.0) and \
Check.equal("zepnina(823, 0.05)", 41.150000000000006) and \
Check.equal("zepnina(823, 0.04)", 32.92)
Check.secret(zepnina(911, 0.043))
...
# zaokrožen na $2$ decimalni mesti natančno.
# Pri zaokroževanju si pomagajte z vgrajeno funkcijo `round` - 
# [dokumentacija](https://docs.python.org/3/library/functions.html#round).
# 
#     >>> zepnina2(800, 0.03)
#     24.0
#     >>> zepnina2(823, 0.05)
...
Check.part()
Check.equal("zepnina2(800, 0.03)", 24.0) and \
Check.equal("zepnina2(823, 0.05)", 41.15) and \
Check.equal("zepnina2(823, 0.04)", 32.92)
Check.secret(zepnina2(911, 0.043))
...
# ostane Mojci potem, ko da Janu žepnino. Znesek naj bo zaokrožen na $2$ decimalni
# mesti natančno.
# 
#     >>> ostane(800, 0.03)
#     776.0
...
Check.part()
Check.equal("ostane(800, 0.03)", 776.0) and \
Check.equal("ostane(823, 0.04)", 790.08)
Check.secret(ostane(911, 0.043))
...
Check.part()
Check.equal("razlika(900, 850)", 50) and \
Check.equal("razlika(600, 700)", -100) and \
Check.equal("razlika(600, 500)", 100)
Check.secret(razlika(800, 799))
