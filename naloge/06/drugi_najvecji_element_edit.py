...
# =====================================================================@032885=
# Napiši funkcijo z imenom `drugi_najvecji`, ki vrne drugi največji element v seznamu. Če se največji element pojavi
# večkrat, njegove ponovitve ne štejejo za drugi največji element: če
# imamo seznam `[5, 1, 4, 8, 2, 3, 8]`, je drugi največji element 5, ne 8.
# 
# Primer:
# 
#     >>> drugi_najvecji([5, 1, 4, 8, 2, 3, 8])
#     5
# 
# Namig:
# Včasih ko iščemo največje in najmanjše elemente, imamo težave, ker ne vemo,
# kateri element bi postavili za začetno vrednost. Lahko si pomagamo z `None`, lahko pa uporabimo tole:
# 
#      najvecji_element = float('inf')
#      najmanjsi_element = float('-inf')
# =============================================================================
def drugi_najvecji(xs):
    ...
    for x in xs:
        if x > prvi:
            drugi = prvi
            prvi = x
        elif x > drugi and x != prvi:
            drugi = x
    return drugi

Check.part()
Check.equal('drugi_najvecji([25, 42, 81, 42, 40, 43, 3, 17, 38, 99])', 81)
Check.equal('drugi_najvecji([56, 4, 69, 56, 81, 0, 40, 17, 84, 5, 84])', 81)
Check.equal('drugi_najvecji([29, 13, 97, 72, 49, 29, 0, 6, 48, 77])', 77)
Check.equal('drugi_najvecji([1, 51, 46, 24, 76, 37, 46, 70, 79, 67])', 76)
