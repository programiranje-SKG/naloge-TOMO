...
# Stopnice
# =====================================================================@032884=
# Stopnišča z neenakimi višinami stopnic lahko opišemo tako, da navedemo višine stopnic, merjene od tal
# (ne od prejšnje stopnice). Po stopnicah, opisanih s takšnim seznamom, pleza robot, ki lahko stopi največ
# 20 cm visoko. Napiši funkcijo kako_visoko(stopnice), ki kot argument prejme višine stopnic, rezultat, ki
# ga vrne, pa pove, kako visoko bo robot priplezal.
# 
...
#     45
# 
# V prvem primeru robot pripleza do višine 50, nato pa se ustavi, ker je naslednja stopnica 21 cm višja od te, na
# kateri stoji. V drugem se ne more povzpeti niti na prvo stopnico. V zadnjem pripleza do vrha.
# =============================================================================
...
Check.part()
Check.equal('kako_visoko([10, 20, 25, 45, 50, 71, 98, 110])', 50)
Check.equal('kako_visoko([30, 40, 50])', 0)
Check.equal('kako_visoko([10, 20, 30, 40, 45])', 45)
Check.equal('kako_visoko([10, 13, 15, 33, 46, 62, 82, 101, 201, 237, 249])', 101)
Check.equal('kako_visoko([5, 10, 20, 36, 40, 59, 78, 86, 97, 109])', 109)
