...
# Prestopno leto
# =====================================================================@032892=
# Sestavi funkcijo `prestopno(leto)`, ki vrne `True`, če je leto
# [prestopno](https://sl.wikipedia.org/wiki/Prestopno_leto)
# v [gregorijanskem koledarju](https://sl.wikipedia.org/wiki/Gregorijanski_koledar),
# sicer pa vrne `False`. Zgled:
# 
#     >>> prestopno(2015)
#     False
#     >>> prestopno(2014)
...
Check.part()
Check.equal("prestopno(2015)", False) and \
Check.equal("prestopno(2014)", False) and \
Check.equal("prestopno(2012)", True) and \
Check.equal("prestopno(2000)", True) and \
Check.equal("prestopno(1900)", False)

Check.secret(prestopno(1))
Check.secret(prestopno(4))
