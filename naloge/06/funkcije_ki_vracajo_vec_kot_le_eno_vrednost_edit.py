...
# njeni $3$ vnuki, ki pojedo vsak enako število piškotov, ponavadi pa jih nekaj
# ostane tudi za ata Janeza. Da bo Mojca hitreje izračunala, koliko piškotov dobi
# vsak vnuk in koliko jih ostane za ata Janeza, napišite
# funkcijo `razdeli_piskote(n)`, ki sprejme število spečenih piškotov,
...
Check.part()
Check.equal('razdeli_piskote(3)', (1, 0)) and \
Check.equal('razdeli_piskote(7)', (2, 1)) and \
Check.equal('razdeli_piskote(54)', (18, 0)) and \
Check.equal('razdeli_piskote(113)', (37, 2))
Check.secret(razdeli_piskote(100))
Check.secret(razdeli_piskote(500))


# =====================================================================@032891=
# Mojci včasih ostane še nekaj piškotov od prejšnjega tedna. To se zgodi, kadar
# ata Janez ne poje vseh piškotov, ki so mu bili namenjeni. Kadar se to zgodi,
# je Mojca hudo užaljena in mu tudi prihodnji teden ne pusti jesti piškotov.
# Ob takih tednih je ona tista, ki poje piškote, ki jih pustijo njeni trije vnuki,
# prav tako pa poje tudi piškote od prejšnjega tedna.
# 
...
Check.part()
Check.equal('razdeli_piskote_drugace(7, 2)', (2, 3)) and \
Check.equal('razdeli_piskote_drugace(54, 1)', (18, 1)) and \
Check.equal('razdeli_piskote_drugace(113, 2)', (37, 4))

Check.secret(razdeli_piskote_drugace(100, 1))
Check.secret(razdeli_piskote_drugace(500, 2))
